...
describe('NavBar Component', () => {
  ...
  it('renders all navigation items', () => {
    ...
    expect(
      screen.getByRole('link', { name: /suggestions/i }),
    ).toBeInTheDocument();
  ...
  it('has correct navigation links', () => {
    ...
    expect(screen.getByRole('link', { name: /suggestions/i })).toHaveAttribute(
      'href',
      '/suggestions',
    );
    ...
    expect(screen.getByRole('link', { name: /shopping/i })).toHaveAttribute(
      'href',
      '/shopping',
    );
  });
