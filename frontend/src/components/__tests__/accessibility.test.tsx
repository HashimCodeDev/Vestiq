...
describe('Accessibility Tests', () => {
  ...
  describe('Header Component Accessibility', () => {
    it('should have proper heading structure', () => {
      ...
      const headingIssues = issues.filter(
        (issue) => issue.rule === 'heading-order',
      );
  ...
  describe('QuickActions Component Accessibility', () => {
    ...
    it('should have proper semantic structure', () => {
      ...
      const structuralIssues = issues.filter(
        (issue) => issue.rule === 'heading-order' || issue.rule === 'landmark',
      );
  ...
  describe('NavBar Component Accessibility', () => {
    it('should have proper navigation structure', () => {
      ...
      const issues = testAccessibility(container);
      const navIssues = issues.filter(
        (issue) => issue.rule === 'landmark' || issue.rule === 'navigation',
      );
  ...
  describe('Keyboard Navigation', () => {
    it('should not have positive tabindex values', () => {
      ...
      const issues = testAccessibility(container);
      const tabindexIssues = issues.filter(
        (issue) => issue.rule === 'tabindex',
      );
