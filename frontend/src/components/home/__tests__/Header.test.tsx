...
describe('Header Component', () => {
  ...
  it('renders morning greeting correctly', () => {
    ...
    expect(screen.getByRole('img', { name: 'Good Morning emoji' })).toBeInTheDocument()
  })
  ...
  it('renders user level badge', () => {
    ...
    expect(screen.getByRole('status', { name: 'User level: Level 3 Sartorial Sorcerer' })).toBeInTheDocument()
  })
  ...
  it('renders profile link with correct accessibility attributes', () => {
    ...
    const profileLink = screen.getByRole('link', { name: 'Go to Test User profile' })
  ...
  it('renders avatar with user photo when available', () => {
    ...
    const avatar = screen.getByRole('img', { name: 'Test User profile picture' })
